...
fragment Images on slideshowMedia_images_BlockType {
  images {
    ... on slides_Asset {
      ...
      src_large: url @transform(width: ${ImageWidth.LARGE}, interlace: "partition", immediately: true)
      placeholder: url @transform(width: ${ImageWidth.PLACEHOLDER}, interlace: "partition", immediately: true)
      height
      width   
    }
  }
